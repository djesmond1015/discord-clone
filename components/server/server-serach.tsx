  ...
  return (
    <>
      ...
      >
        ...
        <kbd
          className='pointer-event-none h-5 inline-flex select-none items-center gap-1 rounded border bg-muted px-1.5
        font-mono text-[10px] ml-auto font-medium text-muted-foreground'
        >
      ...
      >
        <CommandInput placeholder='Please search all channels and members' />
        <CommandList>
